...
public class Login extends JFrame {
	...
	public Login() {
		...
		lblPass.setIcon(new ImageIcon(Login.class.getResource("/Cheie.png")));
		...
		label_1 = new JLabel("");
		label_1.setIcon(new ImageIcon(Login.class.getResource("/User.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(Login.class.getResource("/Exit.png")));
